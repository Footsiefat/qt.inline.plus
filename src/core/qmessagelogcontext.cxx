...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                     \
      len, qptrdiff(offsetof(qt_meta_stringdata_MyQMessageLogContext_t,        \
                             stringdata0) +                                    \
                    ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_MyQMessageLogContext_t
    qt_meta_stringdata_MyQMessageLogContext = {
        {
...
public:
  ...
  MyQMessageLogContext(const char *fileName, int lineNumber,
                       const char *functionName, const char *categoryName)
      : QMessageLogContext(fileName, lineNumber, functionName, categoryName) {}
};

// Public inline Visibility=Default Availability=Available
// /usr/include/qt/QtCore/qlogging.h:66
// [-2] void QMessageLogContext()
extern "C" Q_DECL_EXPORT void *C_ZN18QMessageLogContextC2Ev() {
...
C_ZN18QMessageLogContextC2EPKciS1_S1_(const char *fileName, int lineNumber,
                                      const char *functionName,
                                      const char *categoryName) {
  return new QMessageLogContext(fileName, lineNumber, functionName,
                                categoryName);
}
...
void C_ZN18QMessageLogContext4copyERKS_(void *this_, QMessageLogContext*
logContext) {
  ((QMessageLogContext*)this_)->copy(*logContext);
}*/

extern "C" Q_DECL_EXPORT void C_ZN18QMessageLogContextD2Ev(void *this_) {
